// Typed error hierarchy for the pok SDK.
//
...
// codes (forward compatibility) fall back to the generic `pokError`
 ...
 * `quota_exceeded`) decode to this class — `instanceof pokError`
 * still matches.
 */
...
export class BadRequestError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class UnauthenticatedError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class ForbiddenError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class NotFoundError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class ConflictError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class ValidationError extends pokError {
...
export class PreconditionFailedError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class UnsupportedError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export class InternalError extends pokError {
  constructor(init: pokErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends pokErrorInit {
...
export class RateLimitError extends pokError {
...
/**
 * Decode an HTTP `Response` into the appropriate `pokError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `pokError`.
