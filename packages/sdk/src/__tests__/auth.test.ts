...
//   - pokError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): pok {
  return new pok({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the pok class", () => {
