 ...
 * signature verifier for pok outbound webhook deliveries.
 *
...
/**
 * Compute the canonical pok webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a pok webhook delivery.
 *
