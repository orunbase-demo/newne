...
//   - `~/.config/newne/credentials.json` (0600)
//   - `~/.config/newne/config.json`     (0644)
//
// Override via `NEWNE_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/newne` everywhere
