...
// `@saas/sdk` client class name (`pok`) is intentionally NOT part of
...
export const CLI_BIN = "newne";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "pok";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.l.com";
