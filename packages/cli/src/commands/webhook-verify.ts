// `newne webhook verify` — local cryptographic verification of a
// pok outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `newne login`.
